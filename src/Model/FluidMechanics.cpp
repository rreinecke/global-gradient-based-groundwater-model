...
quantity<MeterSquaredPerTime> FluidMechanics::calculateHarmonicMeanConductance
        (t_vel k_neig,
         t_vel k_self,
...
quantity<MeterSquaredPerTime> FluidMechanics::calculateVerticalConductance(t_vel k_vert_neig,
                                                                           t_vel k_vert_self,
